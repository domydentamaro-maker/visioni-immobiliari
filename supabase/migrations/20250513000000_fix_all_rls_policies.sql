...
-- Create storage bucket if not exists and set policies
...
DROP POLICY IF EXISTS "Authenticated users can insert external constructions" ON public.external_constructions;
DROP POLICY IF EXISTS "Authenticated users can update external constructions" ON public.external_constructions;
DROP POLICY IF EXISTS "Authenticated users can delete external constructions" ON public.external_constructions;
